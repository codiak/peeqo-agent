...
module.exports = {
	...
	*/
	...
	wiredIn: {
		localFolder: 'wiredIn',
		queryTerms: ['wired in', 'programmer', 'hacker'],
		servo: 'alert',
		led: {
			anim: 'blink',
			color: 'red'
	...
	wakeword: {
		...
		sound: null,
		// Alert sound disabled before capture — plays on final-command instead
		// (see listeners.js) so the user hears confirmation after speaking, not before.
	},
